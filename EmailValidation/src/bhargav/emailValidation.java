...
// valid email addresses emails.add("Bhargav@.com"); emails.add("bhargav.power@example.com"); emails.add("manoj@example.me.org");
//invalid email addresses emails.add("power.example@.com"); emails.add("bhargav..@example.com"); emails.add("srinu@.example.com");
